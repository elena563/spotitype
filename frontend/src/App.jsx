  ...
  return (
    <div className="App bg-[#282b2e]">
      <header className="p-6 text-[#1DB954]">
        <h2 className="text-left font-bold text-2xl">SpotiType</h2>
      </header>
      <main className="bg-[url(../public/bg.png)] text-gray-100 px-6 py-40">
        <h1 className="font-bold text-7xl mb-8">What <span className="text-[#1DB954]">type</span> of listener are you?</h1>
